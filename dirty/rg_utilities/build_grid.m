...
T = [mri.vox2ras0(:,2), mri.vox2ras0(:,1), mri.vox2ras0(:,3:4)];

% converting position of meshpoints to the head coordinate system
nodes = ft_warp_apply(T, nodes, 'homogeneous');  % vox2ras0 is the field containing the transformation from voxel to patient space

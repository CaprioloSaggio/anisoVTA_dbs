...
disp('Function prepare_mesh_hexahedral changed at lines 159 and 160')  % ADDED
numlabels = numlabels - 1;  % ADDED
mesh.tissuelabel = {};
...
disp('Function prepare_mesh_hexahedral changed at lines 211 and 212')  % ADDED
shift = 0;  % ADDED
...
disp('Function prepare_mesh_hexahedral changed at lines 219 and 220')  % ADDED
background = 1;  % ADDED
...
disp('Function changed between line 229 and 236')  % ADDED
%{
% delete unused nodes
